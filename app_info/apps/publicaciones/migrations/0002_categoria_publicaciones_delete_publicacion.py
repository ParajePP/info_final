    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(default='Valor Predeterminado', max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Publicaciones',
            fields=[
                ...
                ('categoria', models.ForeignKey(default='Sin categoría', null=True, on_delete=django.db.models.deletion.SET_NULL, to='publicaciones.categoria')),
            ],
            options={
                'ordering': ['-publicado'],
            },
